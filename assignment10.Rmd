...
```
```{r}
#this is the best model I have trained
...
The model with the "this is the best model I have trained' comment is the best model I have trained. It was the forest with ntree = 250
